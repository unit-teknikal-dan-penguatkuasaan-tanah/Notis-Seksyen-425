...
<div class="col-md-3">
    <!--  YOUR MENU HERE -->
    <h4>Menu selenggaraan rekod</h4>
    <a href="searchadmin.php" class="btn btn-primary btn-block">Carian pelajar</a>
    <a href="forminsert.php" class="btn btn-primary btn-block">Kemasukan rekod baharu</a>
